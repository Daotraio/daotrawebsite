...
export const metadata: Metadata = {
  title: "Advertisers",
  description:
    "Scale acquisition across iGaming, Prediction Markets, and Tech Verticals with vetted publisher traffic from Daotra.",
};
...
const VERTICAL_DETAILS = [
  {
    ...
    name: "iGaming",
    description:
      "Sportsbooks and casinos. We only onboard operators holding valid licenses in every market they target through the network.",
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        description="Daotra gives advertisers access to a vetted publisher network across iGaming, Prediction Markets, and Tech Verticals — with fraud screening and full attribution support built in."
        actions={
          <>
      ...
      <section className="border-b border-white/[0.06] py-24">
        <div className="container">
          ...
          <h2 className="mt-3 max-w-xl font-display text-3xl font-semibold tracking-tight text-foreground">
            Built for four specific kinds of offers — not a generic catch-all.
          </h2>
          <div className="mt-12 space-y-4">
            {VERTICAL_DETAILS.map((v) => (
              ...
              >
                <v.icon className="h-8 w-8 shrink-0 text-accent-cyan" strokeWidth={1.5} />
                <div>
      ...
      <section className="py-24">
        <div className="container flex flex-col items-start gap-6 rounded-2xl border border-accent-cyan/20 bg-gradient-to-br from-obsidian-800 to-obsidian-950 p-10 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="font-display text-2xl font-semibold text-foreground">
              Set up your first campaign this week.
            </h2>
            <p className="mt-2 max-w-lg text-sm text-muted-foreground">
              Our onboarding team reviews new advertiser applications within 24–48 hours,
              including a licensing check for regulated verticals.
            </p>
          </div>
          <Button asChild size="lg">
            <a href="https://adv.daotra.io/register">
